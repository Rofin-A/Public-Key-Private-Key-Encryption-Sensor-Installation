/**
 * @classname: InstallerServerAndRSA.Java
 * @author: Rofin A
 */
/*----------------------------------------------------------------------------- 
...
This program uses RSA algorithm to retrieve the private key and decipher 
...
//--------------------Establish connection as a thread---------------------------
    ...
    public void run() {
        ...
        InstallerServerAndRSA is = new InstallerServerAndRSA();
...
//        Get installers designation
                    ...
                    SensorInstaller ins = InstallerServerAndRSA.installer.get(user);
                    if (ins instanceof ChiefSensorInstaller) {
...
//------Capture sensors location,upadte the hashmap,Generate the kml file-------                        
                    ...
                    switch (ret_code) {
                        case 1: {
                            System.out.println("Got visit " + (++InstallerServerAndRSA.i) + " from " + user + ", " + designation + ", a sensor has been moved");
                            ...
                            out.flush();
                            //generate KML
                            InstallerServerAndRSA.generate_kml();
                            break;
                        } // location added
                        case 0: {
                            System.out.println("Got visit " + (++InstallerServerAndRSA.i) + " from " + user + ", " + designation);
                        ...
                        case 5: {
                            System.out.println("Got visit " + (++InstallerServerAndRSA.i) + " from " + user + ", " + designation + ", authorization failure to relocate sensor");
...
//            BigInteger kmsg =  new BigInteger(message.getBytes());
