/**
 * @classname: InstallerClientAndRSA.Java
 * @author: Rofin A
 */
/*----------------------------------------------------------------------------- 
...
This program uses RSA algorithm , the public key of the server is used to encrypt
the session key and securely share it for further communication
-------------------------------------------------------------------------------*/
...
//--------------------------------
    ...
    public static void main(String args[]) {
        ...
        InstallerClientAndRSA installer = new InstallerClientAndRSA();
...
// if not then the symetric key provided at client isnt valid-Exception
    ...
    private static void read_user_inp(InstallerClientAndRSA installer) {
    ...
    private static JSONObject build_json(InstallerClientAndRSA installer) {
